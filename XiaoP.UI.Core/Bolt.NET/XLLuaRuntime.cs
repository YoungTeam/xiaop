...
namespace XiaoP.UI.Core.Bolt
{
	...
	public sealed class XLLuaRuntime
    {
        ...
        [DllImport("XLUE.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool XLLRT_GetNextGlobalAPI(IntPtr hEnum,IntPtr lGlobalAPI);
        ...
        [DllImport("XLUE.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool XLLRT_GetNextGlobalClass(IntPtr hEnum, IntPtr lGlobalClass);
        #endregion
