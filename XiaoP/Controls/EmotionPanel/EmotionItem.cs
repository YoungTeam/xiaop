...
namespace Pandora.Module.Component.EmotionPanel
{
    #region EmotionItem
    ...
    public class EmotionItem : IDisposable
    {
        ...
        public EmotionItem(int id,string text, Image image)
            : this(id,text, "", image)
        {
            _image = image;
        }

        public EmotionItem(int id,string text, string tooltip, Image image)
        {
            _id = id;
            _text = text;
            _toolTip = tooltip;
