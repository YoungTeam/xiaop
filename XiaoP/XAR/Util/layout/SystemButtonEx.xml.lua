...
function System_Button_SetMaxState(self, bMax)
    local attr = self:GetAttribute()
	local maxObj = self:GetControlObject("Thunder.System.Button.Max")
...
function System_Button_SetMiniEnable(self, bEnable)
    local miniobj = self:GetControlObject("Thunder.System.Button.Mini")
...
function System_Button_SetCloseEnable(self, bEnable)
    local closeobj = self:GetControlObject("Thunder.System.Button.Close")
...
function System_Button_Max_OnClick(self)
	...
	local maxObj = owner:GetControlObject("Thunder.System.Button.Max")
	local maxObjattr = maxObj:GetAttribute()
...
function System_Button_Ctrl_OnBind(self)
	...
	if attr.MiniShow then
	    miniobj = xarFactory:CreateUIObject("Thunder.System.Button.Mini", "Thunder.System.ItemEx")
	...
	if attr.MaxShow then
	    maxobj = xarFactory:CreateUIObject("Thunder.System.Button.Max", "Thunder.System.ItemEx")
	...
	if attr.CloseShow then
	    closeobj = xarFactory:CreateUIObject("Thunder.System.Button.Close", "Thunder.System.ItemEx")
