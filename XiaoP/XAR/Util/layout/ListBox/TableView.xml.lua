...
function BuildDragItem(ViewCtrlObj)
	...
	ViewCtrlAttr.DragOutItem = objFactory:CreateUIObject(DragOutItemID, "Thunder.DragItem")
	...
	ViewCtrlAttr.DragItemInView = objFactory:CreateUIObject(DragItemInViewID, "Thunder.DragItem")
