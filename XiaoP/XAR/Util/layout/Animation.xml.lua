...
function ProgressParticle_BindObj(ppa,progress)
	...
	attr.particle_env = XLGetObject("Xunlei.UIEngine.ObjectFactory"):CreateUIObject("", "Thunder.Particle.Env")
	...
	attr.particle_cube = XLGetGlobal("Thunder.Particle.Elements"):CreateCube()
